...
function ColumnComponentFour({handleComponentChange}) {
    ...
    const ColumnOneData = [
        {
            ...
            EventClick: () => handleNavigate("Trending"),
        },
        {
            id: 2,
            name: 'Music',
        ...
        },
        {
            ...
            EventClick: () => handleNavigate("Gaming"),
        },
        {
            id: 4,
            name: 'News',
            ...
            EventClick: () => handleNavigate("News"),
        },
        {
            id: 5,
            name: 'Sports',
            ...
            EventClick: () => handleNavigate("Sports"),
        },
    ...
    <div className="option-1">
            ...
            return(
                <div key={id}>
                    <div className='first-row' title={items.name} onClick={items.EventClick}>
