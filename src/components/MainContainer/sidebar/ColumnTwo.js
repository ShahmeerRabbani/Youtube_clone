...
function ColumnComponentTwo({handleComponentChange}) {
    ...
    const ColumnTwoData = [
        {
            ...
            EventClick: () => handleNavigate("History"),
        },
        {
            id: 2,
            name: 'Watch Later',
            ...
            EventClick: () => handleNavigate("Watch Later"),
        },
        {
            id: 3,
            name: 'Like Videos',
            ...
            EventClick: () => handleNavigate("Like Videos"),
        },
