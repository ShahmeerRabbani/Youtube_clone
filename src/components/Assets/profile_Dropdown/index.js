...
const profileLastRow_Data = [
    ...
    <div className='DropDown' style={{display: isOpen ? 'flex' : 'none'}} >
        ...
        <div className='backButton'>
            <div style={{cursor: 'pointer', position: 'absolute',}} onClick={isClose}>
                <Close/>
            </div>
            <div style={{marginLeft: 65,}}><span>Account</span></div>
        </div>
        <div className='profile_upper'>
            <div className='profileUpper_image'>
                <img src={profilePic}/>
            </div>
            <div className='profileUpper_caption'>
                <span style={{color: '#000'}}>Shahmeer Rabbani</span>
                <span style={{color: 'gray'}}>shahmeerrabbani61@gmail.com</span>
                <span style={{marginTop: 4,}}><a href='#'>Create Channel</a></span>
            </div>
        </div>
        <div className='profile_lower'>
            {ProfileLower_Data.map((items, id)=>{
                return(
                    <div key={id}>

            <div className='profile_box'>
            <div className='profileLower_icon'>
            <svg xmlns={"http://www.w3.org/2000/svg"}  height={25}  width={25} focusable="false" style={{pointerEvents: "none", display: "block", width: "100%", height: "100%",}}>{items.icone}</svg>
            </div>
            <div className='profileLower_caption'>
                <span>{items.name}</span>
            </div>
            <div className='navigate_arrow'>
                {items.keyboardarrow}
            </div>
        </div>
                    </div>
            ...
            {profileSecondRow_Data.map((items, id)=>{
                return(
                    <div key={id}>
                        <div className='profile_box'>
            <div className='profileLower_icon'>
            ...
            {profileThirdRow_Data.map((items, id)=>{
                return (
                    <div key={id}>
                         <div className='profile_box'>
            <div className='profileLower_icon'>
            ...
            <hr/>
            {profileForthRow_data.map((items, id)=>{
                return(
                    <div key={id}>
...
<div className='profile_box'>
        ...
        {profileLastRow_Data.map((items, id)=>{
            return(
                <div key={id}>
